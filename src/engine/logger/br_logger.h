...
#define BR_LOG_DEBUG(msg) br_logger_message(BR_LOG_LEVEL_DEBUG, msg)
#else
...
#define BR_LOG_INFO(msg) br_logger_message(BR_LOG_LEVEL_INFO, msg)
#else
...
#define BR_LOG_WARN(msg) br_logger_message(BR_LOG_LEVEL_WARN, msg)
#else
...
#define BR_LOG_ERROR(msg) br_logger_message(BR_LOG_LEVEL_ERROR, msg)
#else
...
#define BR_LOG_FATAL(msg) br_logger_message(BR_LOG_LEVEL_FATAL, msg)
#else
